      ...
      <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 margin div-none-background text-center">
                  ...
                  <p class="text-justify">Sprawdź zakładkę o stronie, żeby dowiedzieć się więcej o projekice który tworzę.</p><br>
                ...
                <div class="col-md-3 margin div-none-background text-center">
                    <h3>Skontaktuj się</h3><br>
                    <p class="text-justify">Skorzystaj z przycisku poniżej, by sprawdzić dane kontaktowe.</p><br>
                    <a href="../inne_podstrony/kontakt.php"><input type="button" class="btn-primary btn-half" value="Skontaktuj się"></a>
                </div>
                </div>
            </div>
        </div>
