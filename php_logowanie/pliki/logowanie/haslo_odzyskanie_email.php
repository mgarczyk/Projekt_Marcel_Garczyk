...
$mail->Body='Uruchom to hiperlacze, aby odzyskac haslo: <a href="localhost/php_logowanie/logowanie/nowe_haslo.php">localhost/php_logowanie/logowanie/nowe_haslo.php</a>';
