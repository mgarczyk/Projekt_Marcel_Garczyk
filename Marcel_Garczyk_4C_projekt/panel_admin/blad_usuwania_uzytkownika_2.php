        ...
        <div class="row">
            <div class="col-lg-6 margin margin-top">
              <div class="col-lg-12 display_div" style="text-align: justify;">
                Błąd usuwania użytkownika 02. Nie wolno usuwać kont z nadanym uprawnieniem Admin!
              </div><br>
              <a href="wyswietl_uzytkownikow.php"><input type="button" class="btn-primary btn-max" value="Zapoznano się z błędem" /></a><br><br>
          </div>
      </div>
    </div>
  </body>
